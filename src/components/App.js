...
class App extends Component {
  ...
  async componentDidMount() {
    await this.loadWeb3();
    // loadBlockchainData is now synchronous as the data is imported, but we call async logic inside
  ...
  // Changed to synchronous as the deployment data is already imported
  loadBlockchainData() {
    try {
